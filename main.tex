...
\begin{frame}{Oscillation forcée}
    ...
    \[
    \tan(\varphi_p(\omega)) = -\frac{\omega \omega_0}{Q(\omega_0^2 - \omega^2)}
    \]
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}
...
\frame{\frametitle{Premier dispositif}
    \begin{columns}
        ...
        \begin{column}{0.25\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth]{static/modele_2.png}
            \end{figure}
        \end{column}
    \end{columns}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                ...
                \includegraphics[width=0.8\linewidth]{static/pdt-photo.png}
            \end{figure}
            \begin{figure}

                \includegraphics[width=\linewidth]{static/force_1.png}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
...
\begin{frame}
    \frametitle{Régime libre}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{static/libre2.png}
    \end{figure}
    \begin{figure}
        \centering
        \includegraphics[width=0.35\textwidth]{static/demo-mod.jpg}
    \end{figure}
    % \begin{figure}
    %     \centering
    %     \includegraphics[width=\textwidth]{static/analyse-cut.png}
    % \end{figure}
\end{frame}
\begin{frame}
    \frametitle{Mode MFM}
...
\begin{frame}\frametitle{Mise en place du Quatre-Quadrants}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.6\linewidth]{static/sd.jpg}
            \end{figure}
            Temps de réponse: $100 \mathrm{ns}$

            Dimension: $5 \mathrm{mm}$
        
            4 Intensités indépendantes: $I_1, I_2, I_3, I_4$
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.6\linewidth]{static/4q-spot.png}
            \end{figure}
    ...
    \end{columns}
\end{frame}
\begin{frame}\frametitle{Dispositif experimental}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{static/4q-exp.jpg}
    \end{figure}
\end{frame}
\begin{frame}\frametitle{Traitement informatique}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{static/drawing.jpg}
        % \includesvg{static/drawing_out.svg}
    \end{figure}
\end{frame}
{
    ...
    \begin{frame}[plain]
        \centering
        \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{static/nanospeed.jpg}
    \end{frame}
}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Caractérisation de l'effet filtre avec sweep fréquence
        \item Analyse précise de l'effet d'un aimant et verif si équivalent
    \end{itemize}
\end{frame}

\section{Le réseau de Halbach}
\begin{frame}
  \sectionpage{}
\end{frame}
